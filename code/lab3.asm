...
main:
	...
	mov		#BLOCK_POS_Y, r10						;row
	mov		#BLOCK_POS_X, r11						;col
...
drawLoop:
	...
	pop		r13
	pop		r12
	inc 	r12							; increment row
	push	r12
	push	r13
	call	#setAddress

	mov		#NOKIA_DATA, R12			; For testing just draw an 8 pixel high
	mov		#0x03, R13					; beam with a 2 pixel hole in the center
	call	#writeNokiaByte

	pop		r13
	pop		r12
	inc		r13							; increment column
	dec		r12							; decrement row
...
buttonListener:
	bit.b	#BIT2, &P2IN				; bit 2 of P2IN set?
	jz 		leftPressed					; Yes, Left button is down.
	bit.b	#BIT1, &P2IN				; bit 1 of P2IN set?
	jz 		rightPressed					; Yes, Right button is down.
